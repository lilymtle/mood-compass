        ...
        <main>
            <section className="profile">
                <div className="profile__header-container">
                    ...
                    <div className="profile__divider-book">
                    ...
                    <section className="profile__mood-log">
                        <div className="profile__mood-log-container">
                            ...
                            <div className="profile__box--mood-log">
                                <p className="profile__mood-log-subheader">
                                    Today I am feeling...
                                </p>

                                <form className="profile__mood-log-form">
                                    <InputFormField 
                                    className="profile__mood-log-input"
                                    type="text"
                        ...
                        <section className="profile__quote">
                            <div className="profile__quote-container">
                            <div className="profile__divider-asym-curve">
                                <svg data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 120" preserveAspectRatio="none">
